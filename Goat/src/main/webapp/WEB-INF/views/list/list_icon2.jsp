...
<script type="text/javascript" src="/resources/JS/list_icon2.js"></script>
		...
		<div class="align">
			<div class="sort">
				<ul>
					...
					<li><a href="/list/list_icon2?category=${paging.cri.category}&period=${paging.cri.period}&type=${paging.cri.type}&keyword=${paging.cri.keyword}&pageNum=1&amount=${paging.cri.amount}"><img src="/resources/image/align_icon2_1.png" class="sortimg"></a></li>
					<li><a href="/list/list?category=${paging.cri.category}&period=${paging.cri.period}&type=${paging.cri.type}&keyword=${paging.cri.keyword}&pageNum=1&amount=${paging.cri.amount}"><img src="/resources/image/align_icon1.png" class="sortimg"></a></li>
				</ul>
			</div>
		</div>
			<table>
				...
				<c:forEach items="${list }" var="boardlist">
					<tr>
						<td colspan="4"><input type="hidden" value="${boardlist.bno}" id="listbno"><a href="../detail/detail?bno=${boardlist.bno}">${boardlist.title}</a></td>
