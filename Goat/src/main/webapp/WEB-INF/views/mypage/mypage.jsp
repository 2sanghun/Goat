...
<link rel="stylesheet"
	href="../../../resources/CSS/mypage.css?version=1.2" type="text/css">
</head>
<body>
	<div id="container">
			...
			<table>
				<tr class="line">
					...
					<td><input type="text" readonly name="id" id="idchk"
						value="${member.id}"> <span id="idmsg"></span></td>
				</tr>
				<tr>
					<td><span>*</span></td>
					<td>이름</td>
				...
				<tr>
					...
					<td><input type="password" id="pwchk" name="password"
						value="${member.password}"> <span id="pwmsg"></span></td>
				</tr>
				<tr>
					<td><span>*</span></td>
					<td>비밀번호확인</td>
					<td><input type="password" id="rechk"
						value="${member.password}"> <span id="remsg"></span></td>
				</tr>
				<tr>
					<td><span></span></td>
					<td>E-mail</td>
				...
				<tr>
					<td><span>*</span></td>
					<td>주소</td>
					<td><input type="text" class="long" name="addr"
